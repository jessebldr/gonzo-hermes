...
class GatewayConfig:
    ...
    # Profile-based routing: route specific guilds/channels/threads or a
    # direct-message principal to different profiles. See
    # gateway/profile_routing.py. Each entry is a dict with name, platform,
    # profile, and optional guild_id/chat_id/thread_id/chat_type/principal_id.
